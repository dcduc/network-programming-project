...
def execute_command(command, client):
    ...
    if DEBUG:
        ...
        for i in range(1, n_f + 1):
            ...
            packet_size = struct.unpack('3b', data[start_packet_position:end_packet_position])[0]
            print("Packet size: %s " % packet_size)
            packet_data = data[start_packet_position:start_packet_position + 4 + packet_size][5:]  
            ...
            table_name_size = struct.unpack('!B', packet_data[start_position:start_position + 1])
            ...
            original_table_name_size = struct.unpack('!B', packet_data[start_position:start_position + 1])
            ...
            start_position = end_position
            alias_field_size = struct.unpack('!B', packet_data[start_position:start_position + 1])
            ...
            start_position = end_position
            field_size = struct.unpack('!B', packet_data[start_position:start_position + 1])
        ...
        eof_data = struct.unpack('!b', data[start_packet_position + 4:end_packet_position])
        if -2 == eof_data[0]:
            ...
            while True:
                ...
                packet_size = struct.unpack('3b', data[start_packet_position:end_packet_position])[0]
                print(">> Packet size: %s " % packet_size)
                packet_data = data[start_packet_position:start_packet_position + 4 + packet_size]  
